...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-ink" >
      <header className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 pt-8 text-sm font-medium"data-aos="fade-down" data-aos-duration="1500">
        <div className="flex items-center gap-2">
          <span className="flex h-8 w-8 items-center justify-center rounded-full border border-ink/20 text-lg font-bold">
            W
          </span>
        </div>
      ...
      <main >
        <section 
          id="latest-drops"
          className="mx-auto w-full max-w-6xl px-6 pb-12 pt-14" data-aos="fade-in" data-aos-duration="3000">
          <div className="flex items-center gap-3 text-xs uppercase tracking-[0.2em] text-ink/60">
            <div className="flex -space-x-2">
              {["bg-amber-500", "bg-gray-500", "bg-slate-700", "bg-neutral-400", "bg-neutral-800"].map(
                (color, index) => (
                  <span
                    key={color}
            ...
            <span className="text-[10px] font-semibold">Mais de 10 empresas em todo o Brasil já confiaram em projetos desenvolvidos.</span>
          </div>

          <div className="mt-6 max-w-3xl">
            <h1 className="text-4xl font-semibold leading-tight text-ink md:text-6xl">
              Sites criados para mudar o jogo.
            </h1>
          ...
          <div className="mt-5 grid gap-5 md:grid-cols-2" data-aos="fade-up" data-aos-duration="1500">
            {projectShowcase.map((project, index) => (
              ...
              >
                <div className="relative overflow-hidden rounded-3xl bg-black shadow-card transition-transform duration-300 group-hover:-translate-y-1">
        ...
        <section id="services" className="mx-auto w-full max-w-6xl border-t border-fog px-6 py-16" >
          <div className="text-sm text-ink/70"data-aos="fade-right" data-aos-duration="1500">(Serviços)</div>
          <div className="mt-4 grid gap-10 lg:grid-cols-[1.1fr_1fr]">
            <div className="self-start rounded-[28px] bg-fog p-6"data-aos="fade-up-right" data-aos-duration="1500">
              <div className="grid gap-6 sm:grid-cols-1">
                <div className="overflow-hidden rounded-3xl bg-white shadow-card">
                  <img
                    src="/images/Ficticio1.png"
                    alt="Identity mockup"
            ...
            <div className="space-y-8" data-aos="fade-up-left" data-aos-duration="1500">
              ...
              <div className="space-y-8">
                {services.map((service) => (
                  <div key={service.id} className="grid grid-cols-[48px_1fr] gap-1 border-b border-fog pb-20">
        ...
        <section  id="about" className="mx-auto w-full max-w-5xl border-t border-fog px-6 py-16" >
          <div className="text-sm text-ink/70"data-aos="fade-right" data-aos-duration="1500">(Sobre)</div>
          <div className="mt-8 flex flex-col items-start gap-8 md:items-center"data-aos="fade-up" data-aos-duration="1500">
            <img
              src="/images/about.png"
              alt="Wesley Farias portrait"
              className="h w-full max-w-md rounded-[28px] object-cover"
            />
        ...
        <section id="skills" className="mx-auto w-full max-w-6xl border-t border-fog px-6 py-12"data-aos="fade-left" data-aos-duration="3000">
          ...
          <div className="marquee mt-6 rounded-[28px] bg-white py-4">
            <div className="marquee__track">
              {[...skills, ...skills].map((skill, index) => (
                <span
                  key={`${skill}-${index}`}
                  className="mx-5 inline-flex items-center rounded-full border border-ink/10 bg-mist px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-ink/70"
                >
                  {skill}
                </span>
              ))}
      ...
      <footer className="border-t border-fog"data-aos="fade-up" data-aos-duration="1500">
          ...
          <div className="relative w-full max-w-4xl rounded-[32px] bg-white p-6 shadow-card">
            <div className="flex items-center justify-between">
              ...
              <button
                type="button"
                onClick={closeModal}
                className="rounded-full border border-ink/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-ink/70"
                aria-label="Fechar"
              >
                Close
              </button>
            ...
            <div className="relative mt-6 overflow-hidden rounded-3xl bg-black">
              ...
              <button
                ...
                className="absolute left-4 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/90 text-sm font-semibold text-ink shadow-card"
              ...
              <button
                type="button"
                onClick={showNext}
                className="absolute right-4 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/90 text-sm font-semibold text-ink shadow-card"
